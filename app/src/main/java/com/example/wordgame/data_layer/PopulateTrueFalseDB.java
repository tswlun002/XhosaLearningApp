...
public class PopulateTrueFalseDB extends AsyncTask<Void, Void, Void> {
    private final TrueFalseDao trueFalseDao ;
    private Context context;

    protected PopulateTrueFalseDB(WordGameDB wordGameDB,Context context){
    ...
    protected Void doInBackground(Void... voids) {
        ...
        String data ="";
        try {
            data = getData(pictures,answers,questions,instructions);
    ...
    private String getData(List<String> figures,List<String> answers,List<String>questions,List<String> instructions) throws IOException {
