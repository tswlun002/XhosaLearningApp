...
public final class FragmentLevelOneResultsBinding implements ViewBinding {
  ...
  @NonNull
  public static FragmentLevelOneResultsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentLevelOneResultsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_level_one_results, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
